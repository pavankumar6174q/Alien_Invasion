...
class AlienInvasion:
    ...
    def _check_play_button(self, mouse_pos):
         """Start a new game when player clicks"""
    ...
    def _create_fleet(self):
         ...
         number_aliens_x = round(number_aliens_x)
    ...
    def _create_stars(self, number_of_stars):
         """Create a group of stars at random positions"""
    ...
    def _check_bullet_alien_collisions(self):
         ...
         #check for the collision and add the score
         if collisions:
